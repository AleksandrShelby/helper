...
function imgui.OnDrawFrame()
	...
	if imgui.Button(u8"Готовы") then
		...
		imgui.SetCursorPos(imgui.ImVec2(3,76))
			if imgui.Button(u8"1. Расшифровка ПРО") then
		...
		--imgui.Separator()
		if imgui.Button(u8"3. Продам ковш") then
		...
		if imgui.Button(u8"4. Дом в новостройке") then
		...
		if imgui.Button(u8"5. продам НРГ-500") then
		...
		if imgui.Button(u8"6. Набор в семью") then
		...
		if imgui.Button(u8"7. Продам дом в ФК") then
		...
		if imgui.Button(u8"8. Обмен машинами") then
		...
		if imgui.Button(u8"9. Пиар 165 бара") then
		...
		if imgui.Button(u8"Продам закусь в лв 100кк") then
			...
			imgui.SetCursorPos(imgui.ImVec2(418,284))
		...
		if imgui.Button(u8"Продам магазин оружия") then
			...
			imgui.SetCursorPos(imgui.ImVec2(418,310))
		...
		if imgui.Button(u8"10. Продам Дилдо") then
		...
		if imgui.Button(u8"12. Продам симку 1414194") then
				sampSendChat("Отредактируйте объявление: Продам симку 1414194")
		end
			imgui.SetCursorPos(imgui.ImVec2(418,388))
		...
		if imgui.Button(u8"13. Ищу друга(дискорд)") then
				sampSendChat("Отредактируйте объявление: Ищу другда с майкой Дискорд")
		end
			imgui.SetCursorPos(imgui.ImVec2(418,414))
		...
		if imgui.Button(u8"14. Собес СМИ ЛВ") then
		...
		if imgui.Button(u8"16. Продам бронзу по 8к") then
				sampSendChat("Отредактируйте объявление: Продам бронзу по 8к")
				end
				imgui.SetCursorPos(imgui.ImVec2(418,518))
		...
		if imgui.Button(u8"17. Продам шашку таксиста") then
				sampSendChat("Отредактируйте объявление: Продам шашку таксиста за 25кк")
				end
				imgui.SetCursorPos(imgui.ImVec2(418,544))
		...
		imgui.SetCursorPos(imgui.ImVec2(178,570))
		...
		imgui.SetCursorPos(imgui.ImVec2(178,596))
